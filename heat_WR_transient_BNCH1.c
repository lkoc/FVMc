...
//  gcc -o heat_WR_transient_BNCH1.exe heat_WR_transient_BNCH1.c  ranlib.c rnglib.c -fopenmp
// ./heat_WR_transient_BNCH1.exe
//
//
//
// Benchmark 1: ejemplo 1 del paper:
...
#define TMAX 0.5 // maximum temperature of the domain 
...
// Point to calculate the temperature
 ///////////////////////////////////////
 ///////////////////////////////////////
double x_point = 0.5; //x_cable21;          //   L/2; // x coordinate of the point
double y_point = 0.5; //y_cable21 ; // - cable_diam/2-0.002; // y coordinate of the point
// Solucion para x=0.5 ; y=0.5 es 0.737812;
...
int main(void)
{
    ...
    fp = fopen("results_ex3_transientBNCH1.csv", "a"); // open file to append
